...
public:
  ...
  //practice writing my own DFS and compare to the provided ones.
  bool findPath(Vertex source, Vertex sink, std::vector<Vertex> &path, std::unordered_map<Vertex,bool> &visited);
  bool findPath(Vertex source, Vertex sink, std::vector<Vertex> &path);
