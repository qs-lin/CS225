...
//I can safely comment out them all because I simply use differnet ways
//eg. in this code, the add(point p) is to add p to traversal but I will add p's neighbors. 
